...
if __name__ == '__main__':
    ...
    destination_folder = "realaudio"
    num_files_to_copy = 5

    conn_str = f"DRIVER={{ODBC Driver 18 for SQL Server}};SERVER={server_name};DATABASE={database_name};UID={user};PWD={password};"
    ...
    # copy_audio_files(server_name, database_name, user, password, destination_folder, num_files_to_copy)
